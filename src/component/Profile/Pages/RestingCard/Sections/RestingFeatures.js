            ...
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    ...
                    <ul>
                            ...
                            <li><a href="/resting-card">EXIT BREED LIST</a></li>
                            <li><a href="/promote">PROMOTE</a></li>
                            <li><a href="/mutate">MUTATE</a></li>
                            <li><a href="/war-zone">JOIN WAR</a></li> 
                            <li><a href="/war-zone">EXIT WAR</a></li>
                            <li><a href="/sell-cards">SELL</a></li>
                            <li><a href="/purchase-cards">AUCTION</a></li>
                            <li><a href="/sell-cards">WITHDRAW FROM AUCTION</a></li>
                            <li><a href="/sell-auction">WITHDRAW FROM FIXED MARKETPLACE</a></li>
                        </ul>
                        </div>
                    </div>
                    </div>
