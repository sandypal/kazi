...
<div className="col-md-6">
      ...
      <div className="card_info_text">
          ...
          <h3>Confirm mutation?</h3>
              <p>Mutation fee<br></br>
              <span>10 MATIC</span>
              </p>
           
<a className="btn" href="/mutate-congratulations">CONFIRM</a>
          </div>
          </div>
</div>
   </div>
...
export default MutateConfirmText;