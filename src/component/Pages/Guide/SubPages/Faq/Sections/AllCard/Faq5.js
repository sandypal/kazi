  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseThirtyEight" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingThirtyEight">
      <div class="accordion-body">
        <p>A: Players can increase their card collection by breeding them. Breeding is only possible between cards belonging to the same faction. There are two ways players can breed their cards: Breeding with own cards and Breeding with others. After each breeding session, parent cards and the offspring needs 8 hrs from birth to reach maturity so that they can breed with others. In case of cards belonging to factions Blacknet and Alice, there are no gender-based restrictions for breeding. On the other hand, for faction Humanity, players need to choose a male and female card for breeding a new card.</p>
        <p>Breeding cards within your own collection is free of cost.</p>
        <p>To breed with others, players need to put their cards upon the ‘Breed list’. Players can charge money from others to breed with their cards in addition to the standard ‘Breed fee’ within the game.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseThirtyNine" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThirtyNine">
      <div class="accordion-body">
        <p>A: Breeding cannot be done among cards belonging to different factions. After each breeding sessions, parent cards and offspring needs 8 hrs from birth to reach maturity so that they can breed with others.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseForty" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingForty">
      <div class="accordion-body">
       <p>A: While breeding with others, initiators may assign a price for breeding their cards with potential partners. If the fees are reasonable, card owners of a potential partner card can pay up the fee to the initiator so that they can be owners of the offspring cards.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
